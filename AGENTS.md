...
This repo is the source for two **published Splunkbase apps** (publisher: Kudaw SA, both currently at version **1.2.3**, compatible with Splunk Enterprise / Splunk Cloud 8.2–9.4):
